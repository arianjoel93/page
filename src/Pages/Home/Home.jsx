...
const Home = () => {
    ...
    const productSend = [
        { title: "Páginas informativas", image: landing, imgAlt: "landing", price: 2000, message: "Quiero saber más sobre las páginas informativas", view: "https://cornflowerblue-wallaby-596168.builder-preview.com/" },
        { title: "Modelos de regresión con IA", image: lineal, imgAlt: "lineal", price: 4500, message: "Quiero una consulta gratis sobre Modelos de Regreción con IA", view: "https://medium.com/datos-y-ciencia/machine-learning-supervisado-fundamentos-de-la-regresi%C3%B3n-lineal-bbcb07fe7fd" },
        { title: "eCommerce", image: estadistica, imgAlt: "estadistica", price: 12000, message: "Quiero una consulta grátis sobre estadística inferencial", view: "https://lavenderblush-pigeon-326114.builder-preview.com" },
        { title: "Blogs", image: blogs, imgAlt: "blogs", price: 2000, message: " Quiero una consulta gratis para construir mi blog", view: "https://papayawhip-kudu-957129.builder-preview.com/" },
        { title: "Aplicaciones de utilidades", image: utilidades, imgAlt: "utilidades", price: 4000, message: "Quiero una consulta gratis sobre una palicación", view: "https://learn.microsoft.com/es-es/windows-app/overview" },
        ...
        { title: "Modelos de regresión logística", image: logistica, imgAlt: "logistica", price: 4000, message: "Quiero información sobre los modelos de regreción logística", view: "https://www.ibm.com/es-es/topics/logistic-regression" },
    ]
